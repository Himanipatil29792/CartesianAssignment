...
window.onload = function () {
   ...
   function drawScreen() {
       ...
       drawGrid();
       {
           ...
           var V1 = new _Vector__WEBPACK_IMPORTED_MODULE_0__["Vector"](3, 6);
           drawVector(V1, red, 0, 0, true);
           var V2 = new _Vector__WEBPACK_IMPORTED_MODULE_0__["Vector"](5, 9);
           //drawVector(V2, yellow, V1.i, V1.j, true);
           drawVector(V2, yellow, 0, 0, true);
           var V3 = new _Vector__WEBPACK_IMPORTED_MODULE_0__["Vector"](6, 0);
           drawVector(V3, blue, 0, 0, true);
           var V4 = new _Vector__WEBPACK_IMPORTED_MODULE_0__["Vector"](0, 2);
           drawVector(V4, orange, 0, 0, true);
           var V5 = new _Vector__WEBPACK_IMPORTED_MODULE_0__["Vector"](-2, -5);
           drawVector(V5, gray, 0, 0, true);
           var V6 = new _Vector__WEBPACK_IMPORTED_MODULE_0__["Vector"](0, 0);
           drawVector(V6, green, 0, 0, true);
           // var V3 = V1.add(V2);
           // drawVector(V3, blue, 0, 0, true);
       }
